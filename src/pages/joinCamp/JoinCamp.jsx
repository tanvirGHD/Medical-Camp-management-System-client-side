...
const JoinCamp = ({ campName, campFees, location, healthcareProfessionalName, campId, setCampUserCount }) => {  // Added campId and setCampUserCount
  ...
  const handleSubmit = async (e) => {
    ...
    const registrationData = {
      ...
      participantName: user.displayName, // Logged-in user's name
      age,
      phone,
      gender,
      emergencyContact,
